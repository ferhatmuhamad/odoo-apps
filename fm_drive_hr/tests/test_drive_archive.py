...
class TestDriveArchive(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        # yang dibuat tanpa `groups_id` akan LOLOS semua pemeriksaan hak dan
        ...
        cls.staff_user = Users.create({
            ...
            'groups_id': cls.plain_groups})
        cls.boss_user = Users.create({
            'name': 'Atasan', 'login': 'arc_boss', 'groups_id': cls.plain_groups})
